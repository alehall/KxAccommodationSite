...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div style="display: none;">
        ...
        <asp:Button runat="server" ID="KX_BC_RXS_RVStep7"/>
        <asp:Button runat="server" ID="KX_BC_RXS_RVStep8"/>
        <asp:Button runat="server" ID="KX_BC_RXS_RVStep9"/>
        <asp:Button runat="server" ID="KX_BC_RXS_RVStep10"/>
    ...
    <%--Resource--%>
    <asp:Literal runat="server" ID="KX_PCRESOURCE_RNInductionInternationalStudents_PNData" />
    ...
    <script type="text/javascript">
        ...
        function clickNav(newStep) {
            ...
            case "6":
                ...
                break;
            case "7":
                $('#<%=KX_BC_RXS_RVStep7.ClientID%>').click();
                break;
            case "8":
                $('#<%=KX_BC_RXS_RVStep8.ClientID%>').click();
                break;
            case "9":
                $('#<%=KX_BC_RXS_RVStep9.ClientID%>').click();
                break;
            case "10":
                $('#<%=KX_BC_RXS_RVStep10.ClientID%>').click();
                break;
            default:
